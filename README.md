...
5. we use the PTE to get the page frame number (also known as physical frame number, or PFN) - the Intel SDM says, PTE's bit 51:12 gives us the page frame number, and use bit 11 to bit 0 of the virtual address to get the offset.
